...
public class CustomCube : CustomMesh
{
    ...
    void Start()
    {
        ...
        corners[1] = new Vector3(0, 0, depth);
        corners[2] = new Vector3(width, 0, depth);
        corners[3] = new Vector3(width, 0, 0);
        corners[4] = new Vector3(0, height, 0);
        corners[5] = new Vector3(0, height, depth);
        corners[6] = new Vector3(width, height, depth);
        corners[7] = new Vector3(width, height, 0);
    ...
    protected new void OnDrawGizmos()
    {
        ...
        {
            Gizmos.DrawWireSphere(transform.position + v, 0.05f);
        }
    }
